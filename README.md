...
R. Our goal is implement exisitings methods for heritability which aids
the reproducibility and reporting of it’s calculations. `heritable`
works with model outputs from `asreml` and `lme4` and support the
calculations of broad and narrow sense heritability of a variety of
method for single environment breeding trials.
...
Note that this package is under active development!
