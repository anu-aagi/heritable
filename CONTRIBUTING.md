...
This outlines how to propose a change to heritable, inspired by the
tidyverse contribution guide.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("anu-aagi/heritable", fork = TRUE)`.
...
Please note that the heritable project is released with a [Contributor
Code of
Conduct](https://anu-aagi.github.io/heritable/CODE_OF_CONDUCT.md). By
