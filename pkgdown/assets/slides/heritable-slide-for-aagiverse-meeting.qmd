---
title: heritable - Flexible heritability estimation from complex linear mixed models
...
-   support for different model object (`asreml` and `lme4`), with flexible model constructs
...
![*A slide from Fonti's talk*](images/slide.JPG){fig-align="center"}
