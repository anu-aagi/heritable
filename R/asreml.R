...
#' }
h2_Reliability_by_genotype.asreml <- function(
  model,
  target,
  options = NULL,
  marginal = TRUE,
...
#' }
h2_Delta_pairwise.asreml <- function(
  model,
  target,
  type = c("BLUP", "BLUE"),
  options = NULL,
  ...
  # Check if target is random or fixed
  if (type == "BLUE") {
    h2_Delta <- h2_Delta_BLUE_pairwise.asreml(
      model,
      target,
      options,
      marginal,
    ...
    h2_Delta <- h2_Delta_BLUP_pairwise.asreml(
      model,
      target,
      options,
      marginal,
...
#' @keywords internal
h2_Delta_BLUP_pairwise.asreml <- function(
  model,
  target,
  options = NULL,
  marginal = TRUE,
...
#' @keywords internal
h2_Delta_BLUE_pairwise.asreml <- function(
  model,
  target,
  options = NULL,
  marginal = TRUE,
