...
#' Estimate narrow-sense heritability of differences for BLUPs or BLUEs
#' @description Compute narrow-sense heritability of differences
#' using the variance of differences between two BLUPs/BLUEs
#' @aliases h2_Delta_BLUE_parameters
#' @usage
#' h2_Delta_BLUP_parameters(G_g, vd_matrix)
#' h2_Delta_BLUE_parameters(G_g, vd_matrix)
#' @details See [`h2_Delta()`] and reference for full derivation and equation for heritability Delta
...
#' Estimate broad-sense heritability of differences for BLUPs or BLUEs
